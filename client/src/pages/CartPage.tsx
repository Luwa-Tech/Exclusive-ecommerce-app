    ...
    return (
        <main className="px-4 md:px-0 md:mt-[2rem] md:w-[80%] md:mx-auto mb-[4rem]">
            ...
            <div className="md:flex md:flex-col md:gap-4 md:w-[25%]">
                {
                    isMobile && <button className="bg-secondary-700 text-textColor-400 px-[.5rem] py-[.4rem] rounded-[.2rem] uppercase mt-2 w-[100%] hover:opacity-[0.6]">Checkout {formatCurrency(totalPrice)}</button>
                }
                {
                    isDesktop && <DesktopCartSummary totalPrice={totalPrice} />
                }
